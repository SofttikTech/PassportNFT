...
// File: contracts/IPassportNFTToken.sol
...
interface IPassportNFTToken {
    ...
    function mintTokens(address recipient, uint256 id, uint256 mintAmount) external returns (bool);
}
...
contract Crowdsale is Context, ReentrancyGuard  {
    ...
    IPassportNFTToken private _token;
    ...
    // Private Sale price is 100 CRO
    uint256 internal _rate = 100000000000000000000 ;
     ...
     */
    constructor (address payable __wallet, IPassportNFTToken __token) public {
     ...
     */
    function token() public view virtual returns (IPassportNFTToken) {
        return _token;
    }
    ...
    **/
    ...
    function _deliverTokens(address beneficiary, uint256 mintAmount) internal {
        ...
        require(
            token().mintTokens(beneficiary, 1, mintAmount)
...
abstract contract TimedCrowdsale is Crowdsale {
    ...
    uint256 internal _breakTime = 300; // 5mins
...
// File: contracts/PassportNFTICO.sol
pragma solidity ^0.8.0;

contract PassportNFTICO is
    Crowdsale,
    CappedCrowdsale,
    TimedCrowdsale,
    Ownable
    ...
    uint256 public investorHardCap = 20; // 20 NFT
    mapping(address => uint256) public contributions;

    constructor(
        address payable _wallet,
        IPassportNFTToken _token,
        uint256 _cap,
    ...
    function _preValidatePurchase(
        ...
        require(currentMinted() <= _cap, "PassportNFTICO: cap exceeded");
        require(
            weiAmount.div(mintAmount) == rate(),
            "PassportNFTICO: Invalid ETH Amount"
        );

        // Validate inputs
        require(weiAmount != 0, "PassportNFTICO: ETH sent 0");
        require(
            _beneficiary != address(0),
            "PassportNFTICO: beneficiary zero address"
        );
        ...
        require(
            ...
            "PassportNFTICO: No of Mint MaxCap"
        );
